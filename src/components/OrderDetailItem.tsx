...
const OrderDetailItem:FC<OrderDetailItemProps> = ({orderItem, index}) => {
    ...
    return (
        <div className={`flex w-full border-t border-slate-300 py-3.5 justify-between ${index%2 !== 0 ? 'bg-gray-100' : ''}`}>
            ...
            <div className={`w-[45%] flex justify-center flex-col items-center text-center max-[420px]:w-[40%]`}>
            ...
            <div className={`flex flex-col items-center justify-center w-[20%] gap-2 text-center max-[420px]:w-[25%]`}>
            ...
            <div className={`flex items-center justify-center w-[20%] `}>
                ...
                hover:bg-green-600 transition-bg duration-300 ease-in-out max-[600px]:px-1`}>Make a review</button>
            </div>
